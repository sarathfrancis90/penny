...
class VaultStore(context: Context, databaseName: String = "penny-vault.db", private val alias: String = "penny.offline.vault.v1") :
    SQLiteOpenHelper(context, java.io.File(context.noBackupFilesDir, databaseName).absolutePath, null, 3), java.io.Closeable {
    ...
    override fun onUpgrade(db: SQLiteDatabase, oldVersion: Int, newVersion: Int) {
        check(oldVersion in 1..2 && newVersion == 3) { "Unsupported vault schema; migration required" }
