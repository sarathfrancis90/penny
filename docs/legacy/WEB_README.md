# Archived web product documentation


The material below describes the retired web product. Its setup instructions, version claims and feature status do not describe Penny Offline. Retained types, category contracts, privacy/support routes and release tooling must be accounted for before web source removal.

## Penny web expense tracker
...
- [**Agent Documentation Index**](../agents/README.md) - Complete agent operating manual
...
- [**DevOps Guide**](../database/DATABASE_DEVOPS_GUIDE.md) - CI/CD and best practices
- [**Setup Complete**](../database/DATABASE_SETUP_COMPLETE.md) - Infrastructure overview
- [**Firestore Rules**](../database/FIRESTORE_RULES_DEPLOY.md) - Security rules deployment
- [**Permission Fixes**](../database/FIX_FIREBASE_PERMISSIONS.md) - Troubleshooting

### 🎨 Features
- [**AI Conversational Interface**](../features/AI_CONVERSATIONAL_INTERFACE_DESIGN.md)
- [**Budgeting System**](../features/BUDGETING_FEATURE_DESIGN.md)
- [**Conversation History**](../features/CONVERSATION_HISTORY_DESIGN.md)
- [**Groups Management**](../features/GROUPS_MANAGEMENT_DESIGN.md)
- [**Notification System**](../features/NOTIFICATION_SYSTEM_DESIGN.md)
- [**Mobile-First Design**](../features/MOBILE_FIRST_DESIGN_SYSTEM.md)
- [**Passkey Authentication**](../features/IMPLEMENTATION_SUMMARY_PASSKEYS.md)
- [**Receipt Storage**](../features/RECEIPT_STORAGE_IMPLEMENTATION.md)

### 🚢 Deployment
- [**Deployment Guide**](../deployment/DEPLOYMENT.md) - Full deployment instructions
- [**Quick Start**](../deployment/DEPLOY_QUICK_START.md) - Get started in 5 minutes
- [**Firebase Setup**](../deployment/FIREBASE_SETUP.md) - Firebase configuration
- [**Gemini Setup**](../deployment/GEMINI_SETUP.md) - AI integration
- [**PWA Setup**](../deployment/PWA_SETUP.md) - Progressive Web App
- [**Vercel Deployment**](../deployment/VERCEL_DEPLOYMENT_FIX.md) - Vercel-specific fixes

### 🧪 Testing
- [**Testing Guide**](../testing/TESTING_GUIDE.md) - Comprehensive testing strategy
- [**Groups Testing**](../testing/GROUPS_TESTING_GUIDE.md) - Group features testing
- [**Notifications Testing**](../testing/NOTIFICATION_TESTING_GUIDE.md) - Notification testing
- [**Default Group Verification**](../testing/DEFAULT_GROUP_VERIFICATION.md)

### 👨‍💼 Admin
- [**Admin Console**](../admin/ADMIN_CONSOLE_README.md) - Admin dashboard setup
- [**Costs & Monitoring**](../admin/ADMIN_COSTS_AND_MONITORING.md) - Cost tracking
...
See [Admin Console Guide](../admin/ADMIN_CONSOLE_README.md) for details.
